...
function QuickChat1()						
{						
	Say(	"Everybody",	1,	"Hey, what's up??",	"ee_pd09.wav"	);
}   						

function QuickChat2()						
{						
	Say(	"Everybody",	1,	"Target eliminated.",	"c3_targeteliminated.wav"	);
}   						

function QuickChat3()						
{						
	Say(	"Everybody",	1,	"Run away run away...",	"ee_pd32.wav"	);
}   						

function QuickChat4()						
{						
	Say(	"Everybody",	1,	"Alert. Alert. Alert.",	"c5_alertalertalert.wav"	);
}   						

function QuickChat5()						
{						
	Say(	"Everybody",	1,	"AAAAAAAH",	"gen_dth05.wav"	);
}   						

function QuickChat6()						
{						
	Say(	"Everybody",	1,	"Oh, gawwddd!",	"f8_g_ooogod.wav"	);
}   						

function QuickChat7()						
{						
	Say(	"Everybody",	1,	"Look at that sky... so peaceful.",	"f6_dwish_lookitthatl.WAV"	);
}   						

function QuickChat8()						
{						
	Say(	"Everybody",	1,	"I'm scorched! DAMMIT!",	"f4_tiger_imscorched.wav"	);
}   						

function QuickChat9()						
{						
	Say(	"Everybody",	1,	"Later!",	"f2_dm_later.wav"	);
}   						
